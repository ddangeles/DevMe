    ...
    <div>
      ...
      <Card sx={{ bgcolor: 'text.primary', width: '600px', height: '400px', borderRadius: '20px'}}>
        <CardContent color="primary.main">
          ...
          <Typography sx={{ mb: 1.5, fontSize: 30, ml:3, }} color="text.secondary">
            Email: {`${profile.email}`}
          </Typography>
          <Typography sx={{ mb: 1.5, fontSize: 30, ml:3, }} variant="body2" color="text.secondary">
            Education: {`${profile.education}`}
          </Typography>
          <Typography sx={{ mb: 1.5, fontSize: 30, ml:3, }} variant="body2" color="text.secondary">
            Year's Experience: {`${profile.yearsExperience}`}
          </Typography>
          <Typography sx={{ mb: 1.5, fontSize: 30, ml:3, }} color="text.secondary" gutterBottom>
